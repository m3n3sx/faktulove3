        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="h-8 bg-interactive rounded flex items-center justify-center text-white text-xs">
                Primary
              </div>
              <div className="h-8 bg-interactive-hover rounded flex items-center justify-center text-white text-xs">
                Hover
              </div>
              <div className="h-8 bg-interactive-active rounded flex items-center justify-center text-white text-xs">
                Active
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="h-8 bg-status-success rounded flex items-center justify-center text-white text-xs">
                Sukces
              </div>
              <div className="h-8 bg-status-warning rounded flex items-center justify-center text-white text-xs">
                Ostrzeżenie
              </div>
              <div className="h-8 bg-status-error rounded flex items-center justify-center text-white text-xs">
                Błąd
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="h-8 bg-background-primary border border-border-default rounded flex items-center justify-center text-text-primary text-xs">
                Główne
              </div>
              <div className="h-8 bg-background-secondary border border-border-default rounded flex items-center justify-center text-text-primary text-xs">
                Drugorzędne
              </div>
              <div className="h-8 bg-background-muted border border-border-default rounded flex items-center justify-center text-text-primary text-xs">
                Wyciszone
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="h-8 bg-background-secondary rounded flex items-center justify-center text-text-primary text-xs">
                Główny
              </div>
              <div className="h-8 bg-background-secondary rounded flex items-center justify-center text-text-secondary text-xs">
                Drugorzędny
              </div>
              <div className="h-8 bg-background-secondary rounded flex items-center justify-center text-text-muted text-xs">
                Wyciszony
              </div>
            </div>
          </div>
      ...
      <Card className="p-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="p-3 bg-form-valid-background border border-status-success-border rounded">
            ...
            <div className="p-3 bg-form-invalid-background border border-status-error-border rounded">
            ...
            <div className="p-3 bg-form-pending-background border border-status-warning-border rounded">

            ...
            {searchable && (
              <div className="px-3 py-2 border-b border-border-muted">
                <input
                  ...
                  placeholder="Szukaj..."
                  className="w-full px-2 py-1 text-sm border border-border-default rounded focus:outline-none focus:ring-2 focus:ring-primary-600/20 focus:border-border-focus"
                />
              </div>
            )}

...
const GridItem: React.FC<{ children: React.ReactNode; className?: string }> = ({ 
  ...
  <div className={`bg-primary-100 border border-primary-200 rounded-md-lg p-4 text-center text-primary-800 font-medium ${className}`}>
    {children}
  </div>
);
  ...
  render: () => (
    <div>
      ...
      <Grid cols={{ xs: 1, sm: 2, lg: 3 }} gap={6}>
        <div className="bg-white border border-neutral-200 rounded-md-lg p-6 shadow-sm-sm">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="bg-success-100 text-success-800 px-2 py-1 rounded-md text-sm">Opłacona</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-neutral-200 rounded-md-lg p-6 shadow-sm-sm">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="bg-error-100 text-error-800 px-2 py-1 rounded-md text-sm">Przeterminowana</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-neutral-200 rounded-md-lg p-6 shadow-sm-sm">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="bg-primary-100 text-primary-800 px-2 py-1 rounded-md text-sm">Wysłana</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-neutral-200 rounded-md-lg p-6 shadow-sm-sm">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="bg-neutral-100 text-neutral-800 px-2 py-1 rounded-md text-sm">Szkic</span>
          </div>
        </div>
      </Grid>
    </div>
  ...
  render: () => (
    <div>
      ...
      <Grid cols={{ xs: 1, lg: 2 }} gap={6}>
        <div className="bg-white border border-neutral-200 rounded-md-lg p-6">
        ...
        <div className="bg-white border border-neutral-200 rounded-md-lg p-6">
          ...
          <div className="h-32 bg-neutral-100 rounded-md flex items-center justify-center text-neutral-500">
            Wykres przychodów
          </div>
        </div>
      </Grid>

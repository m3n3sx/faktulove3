...
// Card variant styles
const cardVariants = {
  default: 'bg-white border border-neutral-200 shadow-sm-sm',
  outlined: 'bg-white border-2 border-neutral-300',
  elevated: 'bg-white border border-neutral-200 shadow-sm-lg',
...
const Card: React.FC<CardProps> = ({
  ...
  const baseClasses = 'rounded-md-lg overflow-hidden';

...
export const Table = <T extends Record<string, any>>({
  ...
  return (
    <div className={`overflow-hidden rounded-md-lg ${className}`} data-testid={testId} {...props}>
              ...
              {selectable && (
                <th className={`${cellPadding[size]} text-left`}>
                  <input
                    ...
                    className="rounded-md border-neutral-300 text-primary-600 focus:ring-primary-500"
              ...
              <tr>
                ...
                >
                  <div className="flex items-center justify-center gap-2">
                    <div className="animate-spin rounded-md-full h-4 w-4 border-b-2 border-primary-600"></div>
                    Ładowanie...
                  </div>
                </td>
              </tr>
          ...
          {onPageSizeChange && (
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="border border-neutral-300 rounded-md-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              >
              ...
              <React.Fragment key={index}>
                {pageNum === '...' ? (
                  ...
                  <button
                    ...
                    className={`px-3 py-1 text-sm rounded-md-md transition-colors ${
                      pageNum === page

...
export const Compact: Story = {
  ...
  decorators: [
    (Story) => (
      <ThemeProvider>
        <div className="flex items-center justify-center p-4 bg-background-secondary rounded-md-lg">
          <Story />
        </div>
      </ThemeProvider>
    ),
  ...
  render: (args) => (
    <ThemeProvider>
      <div className="space-y-6">
        ...
        <div className="p-6 bg-background-primary border border-border-default rounded-md-lg">
          ...
          <div className="flex gap-2">
            <button className="px-4 py-2 bg-interactive text-white rounded-md-md hover:bg-interactive-hover transition-colors">
              Przycisk główny
            </button>
            <button className="px-4 py-2 border border-border-default text-text-primary rounded-md-md hover:bg-background-hover transition-colors">
        ...
        {/* Status indicators */}
        <div cols={3}>
          <div className="p-3 bg-status-success-background border border-status-success-border rounded-md-lg">
            <div className="text-status-success font-medium">Sukces</div>
            <div className="text-xs text-text-muted">Operacja zakończona</div>
          </div>
          
          <div className="p-3 bg-status-warning-background border border-status-warning-border rounded-md-lg">
            <div className="text-status-warning font-medium">Ostrzeżenie</div>
            <div className="text-xs text-text-muted">Wymaga uwagi</div>
          </div>
          
          <div className="p-3 bg-status-error-background border border-status-error-border rounded-md-lg">
    ...
    <ThemeProvider>
      <div className="space-y-6">
        ...
        <div className="p-6 bg-background-primary border border-border-default rounded-md-lg">
          ...
          <div className="border border-border-default rounded-md-lg overflow-hidden">
          ...
          <div className="mt-4 flex justify-end">
            <div className="bg-invoice-paid-background border border-status-success-border px-3 py-1 rounded-md-full">

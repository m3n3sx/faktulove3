...
export const styleMappings: StyleMapping[] = [
  ...
  { from: 'text-success-600', to: 'text-success-600', deprecated: true, warning: 'Use text-success-600 instead' },
  { from: 'bg-success-600', to: 'bg-success-600', deprecated: true, warning: 'Use bg-success-600 instead' },
  { from: 'text-error-600', to: 'text-error-600', deprecated: true, warning: 'Use text-error-600 instead' },
  { from: 'bg-error-600', to: 'bg-error-600', deprecated: true, warning: 'Use bg-error-600 instead' },
  { from: 'text-warning-600', to: 'text-warning-600', deprecated: true, warning: 'Use text-warning-600 instead' },
  { from: 'bg-warning-600', to: 'bg-warning-600', deprecated: true, warning: 'Use bg-warning-600 instead' },
  ...
  { from: 'rounded-md', to: 'rounded-md-md', deprecated: true, warning: 'Use rounded-md-md for consistency' },
  { from: 'rounded-md-sm', to: 'rounded-md-sm', deprecated: false },
  { from: 'rounded-md-md', to: 'rounded-md-md', deprecated: false },
  { from: 'rounded-md-lg', to: 'rounded-md-lg', deprecated: false },
  
  // Shadow mappings
  { from: 'shadow-sm', to: 'shadow-sm-sm', deprecated: true, warning: 'Use shadow-sm-sm for consistency' },
  { from: 'shadow-sm-sm', to: 'shadow-sm-sm', deprecated: false },
  { from: 'shadow-sm-md', to: 'shadow-sm-md', deprecated: false },
  { from: 'shadow-sm-lg', to: 'shadow-sm-lg', deprecated: false }
];

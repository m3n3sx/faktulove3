...
import { theme, polishBusinessTheme, polishBusinessUtils } from '../utils/theme';
...
export interface ThemeContextValue {
  ...
  toggleContrast: () => void;
  theme: typeof theme;
  polishBusinessTheme: typeof polishBusinessTheme;
  polishBusinessUtils: typeof polishBusinessUtils;
  isDark: boolean;
...
const generateCSSCustomProperties = (config: ThemeConfig, systemPrefersDark: boolean): Record<string, string> => {
  ...
  if (isDark) {
    ...
    // Compliance colors for dark mode
    ...
    // VAT rate colors for light mode
    ...
    // Compliance colors for light mode
...
export const useThemeUtils = () => {
  const { theme, polishBusinessTheme, polishBusinessUtils, isDark, isHighContrast } = useTheme();
